...
class RecommendedPlacesPage extends StatelessWidget {
  const RecommendedPlacesPage({super.key});
...
class RecommendPage extends StatelessWidget {
  ...
  Widget buildPlaceCard() {
    return Container(
      ...
      padding: EdgeInsets.symmetric(horizontal: SizeConfig.w(16), vertical: SizeConfig.h(16)),
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(SizeConfig.w(20)),
        boxShadow: [BoxShadow(color: Colors.black12, blurRadius: SizeConfig.w(6))],
      ),
      child: Row(
        ...
        children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('장소명', style: TextStyle(fontSize: SizeConfig.w(20), fontWeight: FontWeight.bold)),
          ...
          Column(
            ...
            children: [
              Text('상세 주소', style: TextStyle(fontSize: SizeConfig.w(13), color: Colors.black87)),
              SizedBox(height: SizeConfig.h(8)),
              Text('자세히 보기', style: TextStyle(fontSize: SizeConfig.w(13), fontWeight: FontWeight.bold)),
            ],
          )
        ],
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Text(
                'Activity_title',
                style: TextStyle(fontSize: SizeConfig.w(32), fontWeight: FontWeight.bold),
              ),
            ),
            SizedBox(height: SizeConfig.h(40)),
            Padding(
              padding: EdgeInsets.only(left: SizeConfig.w(12)),
              child: Text('추천장소', style: TextStyle(color: Colors.grey[700], fontSize: SizeConfig.w(14))),
            ),
