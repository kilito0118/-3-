...
> **놀래말래**는 여럿이 모였을 때 모두가 만족할 수 있는 **여가활동**을 추천하는 앱입니다.  
...
## 📱 설치 및 실행 방법
[다운로드 링크](https://appdistribution.firebase.dev/i/8265d86567fb9318)


1. 위 링크 접속 후 이메일을 입력하여 테스트 그룹에 추가
2. 이메일로 온 주로슬 통해 apk 다운로드
3. 안드로이드 기기에 앱 설치
4. 회원가입 후 바로 사용 가능
...
clone 후 실행해보시면
api key를 제공하고 있지 않아 바로 실행이 불가합니다.

key가 필요하신 경우, 연락 부탁드립니다.
...
| 이름 | 학번 | 역할 |
|------|------|------|
| 박준혁 | 2023112374 | Firebase, 프론트 일부 |
